...
Array.prototype.square = function () { return this.map(n => Math.pow(n, 2)); }

Array.prototype.cube = function () { return this.map(n => Math.pow(n, 3)); }

Array.prototype.average = function () { return this.length === 0 ? 0 : this.reduce((prev, cur) => prev + cur) / this.length; }

Array.prototype.sum = function () { return this.length === 0 ? 0 : this.reduce((prev, cur) => prev + cur); }
